		...
		foreach ($categoryHierarchy as $cat) {
			if (!empty($cat->children)) {
				...
				<div class="elementor-toggle-item">
					<div class="elementor-tab-title elementor-<?php echo esc_attr($active); ?>" data-tab="<?php echo esc_attr($cat->slug) ; ?>">
						...
						<a class="term_link" href="<?php echo get_term_link($cat);?>"><?php echo esc_attr($cat->name);?></a>
					</div>
					<div id="elementor-tab-content-<?php echo esc_attr($cat->slug) ; ?>" class="elementor-tab-content elementor-clearfix elementor-<?php echo esc_attr($active); ?>" data-tab="<?php echo esc_attr($cat->slug) ; ?>"  style="<?php echo esc_attr($cssdisplay); ?> padding: 0;">
						<!-- content tab -->
						<?php echo esc_attr($this->call_children_html($cat->children)); ?>
