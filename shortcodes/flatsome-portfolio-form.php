        ...
        <?php  
            ...
            if(!empty($fields) and is_array($fields)){                
                foreach ($fields as $value) {
                    ...
                    // metakeys                    
                    if(array_key_exists($value,ADMINZ_Flatsome::get_arr_meta_key())){   
